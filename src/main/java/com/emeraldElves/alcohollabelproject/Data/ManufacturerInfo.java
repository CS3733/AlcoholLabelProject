...
public class ManufacturerInfo {
    ...
    public ManufacturerInfo(String name, String physicalAddress, String company, int representativeID, String permitNum, PhoneNumber phoneNumber, EmailAddress emailAddress) {
        this.name = name;
